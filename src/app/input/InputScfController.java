    ...
    public void initialize() {
    	...
    	if (contMagnet==null){
			try {
				...
				FXMLLoader fxmlLoader0 = new FXMLLoader(this.getClass().getResource("scf/InputScfStandard.fxml"));
				fxmlLoader0.setController(contStandard);
				vboxStandard = fxmlLoader0.load();
				
				contMagnet = new InputScfMagnetController(mainClass);
				FXMLLoader fxmlLoader1 = new FXMLLoader(this.getClass().getResource("scf/InputScfMagnet.fxml"));
				fxmlLoader1.setController(contMagnet);
				vboxMagnet = fxmlLoader1.load();
				
				contHubb = new InputScfHubbardController(mainClass);
				FXMLLoader fxmlLoader2 = new FXMLLoader(this.getClass().getResource("scf/InputScfHubbard.fxml"));
				fxmlLoader2.setController(contHubb);
				vboxHubbard = fxmlLoader2.load();
				
				vboxHybrid = FXMLLoader.load(getClass().getResource("scf/InputScfHybrid.fxml"));
				
				vboxVdw = FXMLLoader.load(getClass().getResource("scf/InputScfVdw.fxml"));
				
				vboxEfield = FXMLLoader.load(getClass().getResource("scf/InputScfEfield.fxml"));
				
				vboxAdvanced = FXMLLoader.load(getClass().getResource("scf/InputScfAdvanced.fxml"));
